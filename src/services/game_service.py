...
class GameService:
    ...
    def calculate_match_result(match, players):
        try:
            ...
            # Update match stats and user stats
            match.stats.rounds += 1

            # Handle match result and update stats
            if result == 'draw':
                match.stats.draws += 1
                ...
                # Return bets to players in case of draw
                ...
                joiner_user.total_games += 1
                # Winner takes the bank
                if match.joiner in match.bets_placed:
                    creator_user.coins += match.stake * 2
                    players[match.creator].add_coins(match.stake * 2)
                ...
                if match.creator in match.bets_placed:
                    ...
                    players[match.joiner].add_coins(match.stake * 2)
